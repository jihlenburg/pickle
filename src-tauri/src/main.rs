...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::settings_state::set_verify_provider,
            commands::settings_state::set_welcome_intro_seen,
            ...
            commands::verification::lookup::find_datasheet,
            commands::verification::run::verify_pinout,
            commands::verification::run::verify_clc,
            commands::verification::overlay::apply_overlay,
            commands::verification::overlay::rename_overlay_package,
            commands::verification::overlay::delete_overlay_package,
            commands::verification::overlay::set_package_display_name,
            commands::verification::overlay::api_key_status,
